...
def get_SLIC_deffirence(img_path1, img_path2):
    for segments in range(900, 901):
        for compact in range(1, 21):
            temp_path = r"J:\发送文件\Atmosphere\GLCM\SLICResult\230128_rpc_clip_SLIC_segments=" + str(segments) + "_compact=" + str(compact) + ".tif"
            ...
            write_img(r"J:\发送文件\Atmosphere\GLCM\SLICResult\230128_rpc_clip_segments_quick2_segments=" + str(segments) + "_compact=" + str(compact) + ".tif",
                      im_proj, im_geotrans, segments_quick.transpose((1, 0)))

            temp_path2 = r"J:\发送文件\Atmosphere\GLCM\SLICResult\231031_rpc_clip_SLIC_segments=" + str(segments) + "_compact=" + str(compact) + ".tif"
            ...
            write_img(r"J:\发送文件\Atmosphere\GLCM\SLICResult\231031_rpc_clip_segments_quick2_segments=" + str(segments) + "_compact=" + str(compact) + ".tif",
...
if __name__ == "__main__":
    ...
    img_path1 = r"J:\发送文件\Atmosphere\GLCM\230128_resample_clipmax_.tif"
    img_path2 = r"J:\发送文件\Atmosphere\GLCM\231031_resample_clipmax_.tif"
